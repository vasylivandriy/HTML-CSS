function t1Condition() {
    ...
    let nine = prompt("9.Ім'я та Прізвище Героя України, який під час Революції гідности у 2014 році цитував поему Шеченка 'Кавказ', один з перших," +
        " хто загинув від куль снайперів.");
